...
export const audioBkgTrack = writable({name: "opening-prompt", path: "./audio/opening-prompt.mp3"});
...
export function audioBkgUpdateTotalTime(time) {
  audioBkgTotalTime.set(time)
};

export function audioBkgUpdateCurrentTime(time) {
  audioBkgCurrentTime.set(time)
};